  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4">
      ...
      >
        ...
        >
          <h1 className="text-3xl text-pink-300 mb-8 leading-relaxed">Operácia: Záchrana toho najcennejšieho...</h1>
          ...
          >
            <p className="text-purple-200 text-lg mb-8 leading-relaxed">
              Písal som a mazal som to už asi stokrát. Žiadne slová mi neprišli dosť dobré na to, aby opísali, ako ma mrzí, že sme v tejto situácii. Nechcem sa skrývať za obrazovku, ale niekde som začať musel...
            </p>
