  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 text-center relative">
      ...
      >
        ...
        >
          Viaceré zdroje potvrdili, že to priateľ sa chová niekedy ako idiot...
        </motion.p>
        <motion.p
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...ale tie isté zdroje tvrdia, že ťa neskutočne ľúbi a mrzí ho to. Chcem to napraviť
        </motion.p>
      </motion.div>
      ...
      >
        ...
        />
        <span className="relative z-10">Poďme sa porozprávať</span>
      </motion.button>
