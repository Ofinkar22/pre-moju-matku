  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4 py-8">
      ...
      >
        ...
        >
          Si to najlepšie, čo ma v živote mohlo stretnúť🌍
        </motion.h2>
        ...
        >
          ...
          >
            Možno nie som úplne vysnívaný ideálny muž, akého si si priala. Možno niekedy robím viac chýb jak by trebalo, ktoré mňa potom vždy mrzia viac, než dokážem povedať. Ale jedna vec je istá, že ťa stále milujem. Nechcem aby sme takto pokračovali ďalej, aj počas toho keď nemáme najelšpei obdobie, lebo viem, že máme aj viac za sebou to ho dobrého ako zlého. Záleží mi na tom, aby si bola šťastná a urobím všetko pre to, aby som ti ten úsmev vrátil na tvár Bubík. Veľmi ťa ľúbim a chýbaš mi.✨
          </motion.p>
          <motion.p
